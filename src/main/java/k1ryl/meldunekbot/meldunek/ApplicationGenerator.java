...
public class ApplicationGenerator {
    ...
    public static void main(String[] args) throws IOException, DocumentException {
        String pdfPath = ApplicationGenerator.class.getClassLoader().getResource("meldunek.pdf").getPath();
        PdfReader reader = new PdfReader(pdfPath);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        PdfStamper stamper = new PdfStamper(reader, baos);
        AcroFields fields = stamper.getAcroFields();
        String[] states = fields.getAppearanceStates("wyrażam zgodę na przekazanie do rejestru danych kontaktowych imienia, nazwiska, numeru PESEL oraz");
